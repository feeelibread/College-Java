...
public class Ex01LanceDados {
	...
	public static void main(String[] args) {
		...
		System.out.println("Resultado dos lances dos dados:");
		...
		total = (float) cont1 / NUM_LANCES * 100 + (float) cont2 / NUM_LANCES * 100 + (float) cont3 / NUM_LANCES * 100
				+ (float) cont4 / NUM_LANCES * 100 + (float) cont5 / NUM_LANCES * 100 + (float) cont6 / NUM_LANCES * 100;
